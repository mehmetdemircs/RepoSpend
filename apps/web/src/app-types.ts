...
export type DisplaySettings = { chartGroupLimit: number; tablePageSize: number };
...
export type PickerOption = { value: string; label: string; icon?: PickerIcon; usage?: number };
...
export const defaultDisplaySettings: DisplaySettings = { chartGroupLimit: 10, tablePageSize: 25 };
